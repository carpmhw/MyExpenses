...
namespace MyExpenses.Api.Migrations
{
    ...
    [Migration("20260829102909_AddBankAccountCurrency")]
    partial class AddBankAccountCurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("HistoricalAdjustedPrices", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_HistoricalAdjustedPrices_Close_Positive", "Close IS NULL OR Close > 0");
                        });
                });
            ...
            modelBuilder.Entity("MyExpenses.Api.Models.StockTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal?>("OpeningMarketValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("StockId", "TradeDate", "Sequence")
                        .IsUnique();

                    b.HasIndex("StockId", "Type", "TradeDate");

                    b.ToTable("StockTransactions", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockTransactions_FeeTax_NonNegative", "Fee >= 0 AND Tax >= 0");

                            t.HasCheckConstraint("CK_StockTransactions_TypeFields", "(Type = 'OpeningBalance' AND Shares > 0 AND Price > 0 AND OpeningMarketValue > 0 AND CashAmount IS NULL) OR (Type IN ('Buy', 'Sell') AND Shares > 0 AND Price > 0 AND OpeningMarketValue IS NULL AND CashAmount IS NULL) OR (Type = 'Dividend' AND CashAmount > 0 AND Shares IS NULL AND Price IS NULL AND OpeningMarketValue IS NULL) OR (Type = 'StockDividend' AND Shares IS NOT NULL AND Shares > 0 AND Price IS NULL AND CashAmount IS NULL AND OpeningMarketValue IS NULL AND Fee = 0 AND Tax = 0)");
                        });
                });
                    ...
                    b.OwnsMany("MyExpenses.Api.Models.BankDetail", "BankDetails", b1 =>
                        {
                            ...
                            b1.Property<decimal>("ConvertedBalance")
                                .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MyExpenses.Api.Models.StockTransaction", b =>
                {
                    b.HasOne("MyExpenses.Api.Models.Stock", "Stock")
