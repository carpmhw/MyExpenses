...
namespace MyExpenses.Api.Migrations
{
    ...
    [Migration("20260825130313_AddStockInvestmentLedger")]
    partial class AddStockInvestmentLedger
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("StockTransactions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_StockTransactions_TypeFields", "(Type = 'OpeningBalance' AND Shares > 0 AND Price > 0 AND OpeningMarketValue > 0 AND CashAmount IS NULL) OR (Type IN ('Buy', 'Sell') AND Shares > 0 AND Price > 0 AND OpeningMarketValue IS NULL AND CashAmount IS NULL) OR (Type = 'Dividend' AND CashAmount > 0 AND Shares IS NULL AND Price IS NULL AND OpeningMarketValue IS NULL)");
                        });
                });
