...
export function dataSchema(properties, required = Object.keys(properties)) {
...
export const transactionPageSchema = dataSchema({
    ...pageSchema(transactionSchema).properties,
    summary: dataSchema({ totalIncome: money, totalExpense: money }),
});
export const consumptionSchema = dataSchema({
    ...pageSchema(dataSchema({ sourceType: { enum: ['ordinary', 'credit_card'] }, sourceId: idSchema, date, amount, description: nullableText })).properties,
